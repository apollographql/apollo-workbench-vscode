...
import {
  ...
  AllTypeInfo,
  IPosition,
} from './types/graphql-language-service-types';
...
export function getTokenAtPosition(
  ...
  let styleAtCursor: string | null = null;
  let stateAtCursor: State | null = null;
  let stringAtCursor: string | null = null;
      ...
      case RuleKinds.ARGUMENTS: {
        if (!state.prevState) {
          ...
          switch (state.prevState.kind) {
            case RuleKinds.FIELD:
              argDefs =
                fieldDef && new Array<GraphQLArgument>(...fieldDef.args);
              break;
            case RuleKinds.DIRECTIVE:
              argDefs =
                directiveDef &&
                new Array<GraphQLArgument>(...directiveDef.args);
              break;
            case RuleKinds.ALIASED_FIELD: {
